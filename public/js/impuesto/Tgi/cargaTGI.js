...
async function calcularBroches() {
    ...
    btnCalcular.addEventListener('click', async function (e) {
        ...
        const url = `${baseUrl}/mostrar_broches/${anio}/${mes}/${cant_broches}`;
...
async function guardarNumBroches() {
    ...
    btnCalcular.addEventListener('click', async function (e) {
        ...
        const url = `${baseUrl}/guardar_num_broches/${anio}/${mes}/${cant_broches}`;
...
async function guardarNumBrocheSalas() {
    ...
    const anio = document.getElementById('anio').value;
    const mes = document.getElementById('mes').value;
    const url = `${baseUrl}/guardar_num_broche_salas/${anio}/${mes}`;
...
async function totalMontoTgiCargados() {
    ...
    const url = `${baseUrl}/sumar_montos/${anio}/${mes}`;
...
async function buscarTGIManual() {
    ...
    btnBuscar.addEventListener('click', async function (e) {
        ...
        const url = `${baseUrl}/tgi_padron/obtener/${folio}/${empresa}`;
        ...
        try {
            ...
            if (response.ok && response.data) {
                ...
                // referencia al tbody
                const tbody = document.getElementById('tablaResultadosTGI');
                ...
                response.data.forEach(registro => {
                    ...
                    fila.innerHTML = `
                        ...
                        <td>${registro.administra}</td>
                        <td class="text-center">
                            <button type="button" 
                                    class="btn btn-outline-success btn-sm btnSeleccionar"
                                    data-id="${registro.id}"
                                    data-folio="${registro.folio}"
                                    data-partida="${registro.partida}"
                                    data-clave="${registro.clave}"
                                    data-administra="${registro.administra}">
                                Seleccionar
                            </button>
                        </td>
                    `;
