function crearUnidadVacia(index) {
        ...
        <div class="row d-flex justify-content-between pb-2">
            <div class="col-md-4">
                <div class="input-group">
                    ...
                    <select class="form-select" name="repetir[${index}][tipo]">
            ...
            <div class="col-md-4">
                <div class="input-group">
                    ...
                    <select class="form-select" name="repetir[${index}][estado]">
        ...
        <div class="row d-flex justify-content-between pb-2">
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="repetir[${index}][unidad]" style="height: 34px;">
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-text text_modal_m" style="height: 34px;">Piso</span>
                    <input type="number" class="form-control" name="repetir[${index}][piso]" style="height: 34px;">
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group">
        ...
        <input type="hidden" name="repetir[${index}][comentario]" class="comentario-hidden" data-index="${index}">
        <hr>
    `;
