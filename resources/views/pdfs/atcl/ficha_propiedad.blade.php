        ...
        <div class="col-4 row p-0 m-0">
            ...
            <div class="card-body col-12 ">
                <div class="row ">
                    ...
                    <div class="col-12 ficha-propiedad_contenido">
                         @if(isset($propiedad['piso']) && $propiedad['piso']) Piso {{ $propiedad['piso'] }}   @endif
                        @if(isset($propiedad['departamento']) && $propiedad['departamento']) Depto {{ $propiedad['departamento'] }} @endif
                    </div>
                    <div class="col-12 ficha-propiedad_contenido">
                        {{ $propiedad['zona']['name'] ?? '' }}
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 ficha-propiedad_contenido text-center">
                        @if(isset($propiedad['asfalto']) && $propiedad['asfalto'] == 'SI') Asfalto @endif
                        @if(isset($propiedad['gas']) && $propiedad['gas'] == 'SI') • Gas @endif
                        @if(isset($propiedad['cloaca']) && $propiedad['cloaca'] == 'SI') • Cloaca @endif
                        @if(isset($propiedad['agua']) && $propiedad['agua'] == 'SI') • Agua @endif
                        @if(isset($propiedad['ph']) && $propiedad['ph'] == 'SI') • PH @endif
                    </div>
                </div>
                <hr class="mt-1 mb-1">
                <div class="row">
