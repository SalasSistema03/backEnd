...
<body>
    ...
    // Leemos la variable detallado (por defecto true si no viene)
    ...
    // Calculamos el total de la unidad previamente para tenerlo siempre disponible
    $totalCupon = 0;
    foreach($conceptos as $c) {
        ...
        <div class="col-4 ps-3">
            <div class="cupon-container h-100 bg-light">
                ...
                <div class="mt-4 text-center">
                    <!-- Espacio de firma si se requiere -->
                </div>
