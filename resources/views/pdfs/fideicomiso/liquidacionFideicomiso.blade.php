...
<head>
    ...
    <style>
        ...
        .tabla-masiva { margin-bottom: 0 !important; }
        .tabla-masiva th, .tabla-masiva td {
            font-size: 0.55rem; padding: 0.1rem 0.15rem !important; 
            vertical-align: middle; text-align: center; line-height: 1; white-space: nowrap;
        }
        .tabla-masiva th { font-size: 0.5rem; }
        .tabla-individual th, .tabla-individual td { font-size: 0.8rem; padding: 0.2rem !important; }
        .cupon-container { border: 2px dashed #ccc; padding: 8px 10px; border-radius: 8px; }
    </style>
</head>
<body>
    @php
    ...
    <div class="row m-0 w-100 justify-content-center">
        ...
        <!-- ================= LADO DERECHO ================= -->
        <div class="{{ $detallado ? 'col-4 ps-3' : 'col-6 mx-auto mt-5' }}">
            <div class="cupon-container h-100 bg-light">
                ...
                <div class="text-center mb-2 border-bottom pb-2">
                    ...
                    <small>Período: {{ $mes }} / {{ $anio }}</small> <br>
                     <small>IMPUESTO Y EXPENSAS</small>
                </div>
                        ...
                        <tbody>
                            @foreach($conceptos as $c)
                                @if(isset($registroClick[$c]) && floatval($registroClick[$c]) > 0)
                                    @php 
                                        $textoPeriodo = '';
                                        if ($c === 'tgi') $textoPeriodo = "$mes";
                                        elseif ($c === 'api') $textoPeriodo = "$mesBimestreStr";
                                        elseif ($c === 'agua') $textoPeriodo = "$mesBimestreStr $cuotaAgua";
                                    @endphp
                                    <tr>
