    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 16px; box-shadow: 0 4px 24px rgba(0,0,0,0.08); border: none;">
            <div class="modal-header" style="border-bottom: 1px solid #e9ecef; background: #f8fafc;">
                <h5 class="modal-title fw-semibold" id="staticBackdropLabel" style="letter-spacing: .5px;">Búsqueda de Propiedades en venta</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body pb-2" style="padding-bottom: 0;">
                <div style="position: sticky; top: 0; z-index: 10; background: #fff; border-radius: 12px 12px 0 0; box-shadow: 0 2px 8px rgba(0,0,0,0.04); padding-bottom: 10px;">
                    <form autocomplete="off">
                        <div class="row g-2 mb-1">
                            <div class="col-md-4">
                                <label class="form-label mb-1">Código</label>
                                <input type="number" id="inputCodigoPropiedad" class="form-control form-control-sm" placeholder="Código">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label mb-1">Calle</label>
                                <input type="text" id="inputCallePropiedad" class="form-control form-control-sm" placeholder="Calle">
                            </div>
                            <div class="col-md-2 d-flex align-items-end">
                                <button type="button" id="btnBuscarPropiedades" class="btn btn-primary btn-sm w-100" style="border-radius: 16px;">
                        ...
                        <table id="tabla_filtraPropiedades" class="table table-sm table-borderless align-middle mb-0">
                            <thead style="background: #e9f0fa;">
                                <tr style="font-size: 0.97rem; color: #0d6efd;">
                                    <th scope="col" class="text-center fw-semibold">Cod venta/alquiler</th>
