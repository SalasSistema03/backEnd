...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('historial_criterios_conversacion', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('historial_criterios_conversacion');
    }
};
